...
Able is a monorepo, but this directory is intentionally empty in the first public release. The working Desk application remains one buildable workspace while its module boundaries are proven.
